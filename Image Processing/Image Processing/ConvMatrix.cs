...
namespace Image_Processing
{
    public class ConvMatrix
    {
        ...
        public static bool smoothImage(Bitmap b, int nWeight /* default to 1 */)
        ...
        public static bool gaussianBlurImage(Bitmap b, int nWeight /* default to 1 */)
        ...
        public static bool sharpenImage(Bitmap b, int nWeight /* default to 1 */)
        ...
        public static bool meanRemovalImage(Bitmap b, int nWeight /* default to 1 */)
        ...
        public static bool embossImage(Bitmap b, int nWeight /* default to 1 */, int type)

        {
            ...
            switch(type)
            {
                ...
                case 5:
                    Console.WriteLine("Horizontal Only");
                ...
                case 6:
                    Console.WriteLine("Vertical Only");
                    m.TopLeft = 0; m.TopMid = -1; m.TopRight = 0;
